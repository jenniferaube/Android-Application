...
class DatabaseHelper extends SQLiteOpenHelper {
    ...
    static final String name = "ALARMS_TABLE";
    ...
    private static final String CREATE_TABLE_MSG = "create table " + name + "(" + KEY_ID  + " INTEGER PRIMARY KEY AUTOINCREMENT, "  +
        KEY_DAY + " text, " + KEY_TIME + " text, " + KEY_TEMP + " text );";
    ...
    /*public String selectDay(int position){
        String [] args={String.valueOf(position)};
        String day;
        day = db.execSQL("SELECT " + KEY_DAY + " FROM " + name + " WHERE " + KEY_ID + "=" + args + ";");
        return day;
    }*/
}
